...
<body>
	...
	<div class="result_box">
        ...
        <div class="buttons">
            ...
            <button class="top">Top Ninja</button>
        </div>
    </div>
    ...
    <div class="top_box">
        ...
        <header>
			<div class="title">Top Ninja</div>
		</header>
		<section>
        	<div class="top_list">
				<div class ="top1">
				 <!-- 	<span> datnlq@ask       datnlq        12</span> -->
				</div>
				<div class ="top2">
				 <!-- 	<span>Hyper texttttttttttttt</span> -->
				</div>
    ...
    var scorelist = "<?php echo"$scorelist"?>" 
	...
	const top_quiz = document.querySelector(".top");
	const top_boxquiz = document.querySelector(".top_box");
	...
	restart_quiz.onclick=()=>{
	  ...
	  top_boxquiz.classList.remove("activeTop");
	  activeQuiz();
	}
	let que_count = 0;
	let que_numb = 1;
	...
	function showTop(){
	    result_box.classList.remove("activeResult");
	    top_boxquiz.classList.add("activeTop");


	    let top_tag = '<div class="top1"><span>'+  topserver[0].username  + userScore +'  </span></div>'
	                        + '<div class="top2"><span>  '+  topserver[1].username  +' </span></div>'
	                        + '<div class="top3"><span> '+  topserver[2].username  +'  </span></div>'
	                        + '<div class="top4"><span> '+  topserver[3].username  +' </span></div>';
	    top_list.innerHTML = top_tag ;
	}
...
$sql = "INSERT INTO Top (username,email,Score) VALUES (:username,:email,:score)";
    		$stmt = $db->prepare($sql);
